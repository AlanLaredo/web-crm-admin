...
@Component({
  selector: 'projected-data-grid-component',
  templateUrl: './projected-data-grid.component.html',
  styleUrls: ['./projected-data-grid.component.scss']
})
export class ProjectedDataGridComponent {
  @Input('data')
  set data (data: any[]) {
    if (data !== null) {
      this._data = data
