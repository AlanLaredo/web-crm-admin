...
@Component({
  selector: 'prenominal-grid-component',
  templateUrl: './prenominal-grid.component.html',
  styleUrls: ['./prenominal-grid.component.scss']
})
export class PrenominalGridComponent {
  @Input('data')
  set data (data: any[]) {
    if (data !== null) {
      this._data = data
